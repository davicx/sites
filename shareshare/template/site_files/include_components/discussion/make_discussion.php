...
<div class = "new-discussion">
	<form action="" method="post" enctype="multipart/form-data" id="">
		...
		<div class = "new-discussion-area">
			...
			<!-- Text Input Area -->
			<textarea name="new-discussion" id = "js-new-discussion-text-area" class = "new-discussion-text-input" placeholder="Make Comment "></textarea><br />
			<p id = "js-submit-discussion" class = "temp-discussion-buttton"> Submit </p>						
			<p id = "" class = "js-cancel-discussion-post temp-discussion-buttton"> Cancel </p>			
