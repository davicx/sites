...
//C:\wamp\www\sites\template\site_files\include_components\user
?>
...
<div id = "profile"> 
	...
	<?php if($currently_on_your_page == 1) { ?>
		<p class = "edit-profile-text"><a href="include_components\user\edit_user_profile.php" id="" class="">Edit Profile </a></p>
	<?php } ?>
