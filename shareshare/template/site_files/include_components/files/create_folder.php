...
<div id = "create-new-folder">
	<p class = "js-show-create-folder"> Folder + </p>
</div>
...
<div id = "js-create-new-folder-area" class = "hide new-folder-area">
	...
	<p id = "js-save-new-folder-create" class = "button-temp"> Create + </p>
	<p class = "js-cancel-create-folder button-temp"> Cancel </p>
 
	<!-- Hidden Values -->
	<input type="hidden" id = "js-parent-folder" value = "<?php echo $parent_folder; ?>"> 
