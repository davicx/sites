...
<div id = "">
	<a href="#new-post-modal" data-uk-modal class = ""> Post (+) </a>
</div>

<!-- MODAL: Make a New Post -->
<div id="new-post-modal" class="uk-modal ">
    <div class="uk-modal-dialog">
		...
		<div class="uk-grid ">
			...
			<div class="uk-width-2-10 post-select-type">
				<div id = "js-post-select-photo" class = "">
					<img title = "" src="<?php echo ICON; ?>make_post/photo_dark.png" class = "" alt="">
			...
			<!-- Post Type: Video -->			
			<div class="uk-width-2-10 post-select-type">
				<div id = "js-post-select-video" class = "">
					<img title = "" src="<?php echo ICON; ?>make_post/video.png" class = "" alt="">
					<p id = "js-new-post-selected-type-video"  class = "js-new-post-selected-type make-post-text" > Video </p>
				</div>
			</div>

			<!-- Post Type: Article -->			
			<div class="uk-width-2-10 post-select-type" class = "">
				<div id = "js-post-select-article">
					<img title = "" src="<?php echo ICON; ?>make_post/article_2.png" class = "" alt="">			
			...
			<div class="uk-width-2-10 post-select-type" class = "">
				<div id = "js-post-select-text">
					<img title = "" src="<?php echo ICON; ?>make_post/text.png" class = "" alt="">			
			...
			<div class="uk-width-2-10 post-select-type" class = "">
				<div id = "js-post-select-file">					
					<img title = "" src="<?php echo ICON; ?>make_post/file.png" class = "" alt="">			
