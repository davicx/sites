...
$(document).ready(function(){
	$.getJSON("rest_api.php", function(result){
		...
		$(result.users).each(function(index, value) {
			console.log(value);
			$('<div id = "js-full-user_' + value.id + '"><p id = "current-id_' + value.id + '" class = "js-user">' + value.name + ' </p>' + '<img src="../../user_uploads/user_image/' + value.user_image + ' " class = "user-image"></div>').appendTo( "#users" );
		});
	});
});
