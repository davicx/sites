...
//Show Use Article 
$(document).ready(function(){
	$("#js-show-article-link").click(function(){		
		$("#js-article-upload").hide();		
		$("#js-article-link").show();		
    });
});

//Show User Upload  
$(document).ready(function(){
	$("#js-show-article-upload").click(function(){		
		$("#js-article-link").hide();		
		$("#js-article-upload").show();			
    });
});

//PART 2: Post from URL

//PART 3: Post from Upload		
*/
