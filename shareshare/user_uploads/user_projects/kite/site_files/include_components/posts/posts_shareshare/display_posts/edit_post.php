<div class = "edit-post-holder">	
	<div class = "absolute-position">
		<div id = "js-edit-post-dropdown" data-uk-dropdown="{mode:'click' }">
			...
			<!-- Trigger Dropdown -->
			<div id = "js-edit-post-trigger_<?php echo $post_id; ?>" class = " edit-post-trigger hide <?php echo $display_post_settings; ?>">
				<img title = "Edit Post" src="<?php echo ICON; ?>edit\edit_two.png" class = "edit-post-icon" alt="">
			</div>

			<!-- Dropdown -->
			<div id = "js-edit-post-menu_<?php echo $post_id; ?>" class="uk-dropdown edit-post-dropdown">
				...
				<div id = "js-post-settings_<?php echo $post_id; ?>" class = "js-post-settings <?php echo $display_post_settings; ?>"> 	
					...
					<p id = "" class = "js-close-edit-menu"> Cancel </p>				
				</div>				
