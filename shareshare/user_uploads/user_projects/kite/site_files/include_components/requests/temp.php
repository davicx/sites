			...
			if(strcasecmp($request_type,"new_group") == 0) { ?>
				...
				<div id = "" class="request-accept-area">			
					<div class = "button-request button-request-accept">  
						<p id = "js-accept-group-request_<?php echo $sent_by_id; ?>" class = "js-accept-group-request button-request-text">Accept</p>
					</div>
				</div>			
				...
				<div id = "" class="request-decline-area">			
					<div id = "" class="button-request button-request-decline">	
						<p id = "js-decline-group-request_<?php echo $sent_by_id; ?>" class = "js-decline-group-request button-request-text">Decline</p>		
					</div>		
				</div>		
			
			<?php
			//Request Type 2: New Friend Request
