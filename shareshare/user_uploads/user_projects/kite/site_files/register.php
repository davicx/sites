...
<?php /*
			...
			<section id = "js-registration-area"  class = " registration-area">
				...
				<!-- Message if User is Responding to Request -->
				<div id = "" class = "<?php echo $responding_to_request_message; ?> registration-invite-response-holder ">
					<p> <?php echo $invite_message; ?> </p>
				</div>
				...
				<form id="" class = "" method="post" action="">
					...
					<!-- Submit Registration -->
					<input name="register" type="" id="js-register-user" class = "button-blue register-button " value="Register">					
