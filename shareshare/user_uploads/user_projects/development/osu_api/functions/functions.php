...
FUNCTIONS C: File Handling
	...
	5) Function C5: Get File Folder Name  
	6) Function C6: Check that File is Valid and Can Be Downloaded  
...
//Function C5: Get File Folder Name  
function getFolderName($current_folder){
	global $conn;

	if ($result = mysqli_prepare($conn, "SELECT file_name FROM files WHERE file_id=?")) {
		$result -> bind_param("i", $current_folder);
		$result -> execute();
...
//Function C6: Check that File is Valid and Can Be Downloaded 
