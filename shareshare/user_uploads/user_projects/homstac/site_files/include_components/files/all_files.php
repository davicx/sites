...
/*
<!-- FILE --> 
<div id = "js-file_<?php echo $file_id; ?>" class = "hide js-file js-file-right-click js-draggable file ">
	
	<!-- File Icon -->
	<div class = "js-file-icon file-icon">
		<div class="thumb" style="background-image: url('<?php echo USER_FILE_UPLOADS; ?>image.png');" title=""></div>		
	</div>
	...
	<!-- File Modified -->
	<div id = "" class = "js-file-modified file-modified">
		<p class = "file-modified-text"> <?php echo $file_modified; ?> </p>
	</div>			
	
	<!-- File Size -->
	<div id = "" class = "js-file-settings file-download ">
		<a href="download.php?file_download_path=<?php echo urlencode($file_path);?>&file_name=<?php echo $file_name_and_type; ?>" id = "js-file-download-link_<?php echo $file_id; ?>" >
			<img title = "" src="<?php echo ICON; ?>download/.png" class = "file-download-image" alt="">D
			<?php //echo " " . $file_size; ?> 
		</a>
	</div>	

	<!-- File Setting -->
	<div id = "" class = "js-file-settings file-settings">
	
		<!--<img title = "" src="<?php echo ICON; ?>menu_icon/side_one.png" class = "file-settings-image" alt="">-->
		<?php include('include_components/files/file_settings.php') ?>
	</div>							

	<!-- Hidden Input Variables -->
	<input type="hidden" name="logged-in-user"  id = "" value = "<?php echo $logged_in_user; ?>"> 						
	<input type="hidden" name="file-extension"  id = "" value = "<?php echo $file_type; ?>"> 
	<input type="hidden" name="is-folder"  id = "" value = "0"> 
</div>	 
