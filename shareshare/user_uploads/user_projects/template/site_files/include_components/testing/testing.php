    ...
    <section class="container">
        ...
        <div class="col-xs-12">
            <div class="facility">
                <div class="row">
                    <!-- Site Header -->
<div class="card facility-header flex">
    <div class="col-xs-12 col-sm-4 col-lg-3 header-img">
		<img src="image.png" alt="Alpha 3 - Corvallis Lab" >
	</div>
    <div class="col-xs-12 col-sm-4 col-lg-6 text-center facility-address-box">
        <h3 class="card-header text-left">Alpha 3 - Corvallis Lab</h3>
        <div class="col-xs-1 map-marker">
            <i class="fa fa-map-marker"></i>
        </div>
        <p class="col-xs-9 col-lg-6 text-left">123 somewhere</p>
    </div>

    <div class="col-xs-12 col-sm-4 col-lg-3">
        
        
        <a href="/site/57ffbc26-3c72-11e8-8498-b88198600e3c/site-configuration">
        
        <div class="card col-xs-12 site-card">
            <div class="col-xs-12">
                <div class="col-xs-12 flex">
                    <p class="show-date-time" data-timezone ="2018-06-14 01:18:52PM PDT" data-dateformat="YYYY-MM-DD hh:mm:ssA z">2018-06-14 01:18:52PM PDT</p>
                    <img class="flex-center cluster-icon" src="/images/icons/cluster-status/icon-1.png" alt="" data-bind-attr="src site_information.sbg_unit.unit_status:change_image_png,/images/icons/cluster-status/icon-">
                </div>
            </div>
            <div class="col-xs-12">
                <hr class="full flat-top light-space-bottom" />
            </div>
            <div class="col-xs-12 flex">
                <div class="col-xs-12">
                    <img src="/images/icons/sbg/icon-1.png"
                         alt="" data-bind-attr="src site_information.sbg_unit.unit_status:change_image_png,/images/icons/sbg/icon-" class="inline-block pull-left space-right building-icon"/>
                    <p class="large">SBG Alpha-3</p>
                    <p>SBG100 - 17366000100043</p>
                </div>
            </div>
            <div class="col-xs-12 flex">
                <div class="col-xs-12 flex-center">
                    <p class="clear-both large">Status: <span class="lighter" data-bind-html="site_information.site_status_message">Online</span> <!--<i class="fa fa-chevron-right pull-right"></i></p>--><!-- Add when box becomes link -->
                </div>
            </div>
        </div>
        </a>
                        ...
                        <div class="map-activity-height">
                            ...
                            <div class="col-xs-12 col-md-6 activity-container">
                                <div class="correct-height">
                                    <div class="card col-xs-12 full-height">
                                        <h3 class="card-header pad-left">Activity &amp; Alerts </h3>
                                        <div class="col-xs-12">
                                            <hr class="full">
                                        </div>
                                        <div class="col-xs-12 status-feed scrollbar" id="custom-scroll">
                                        ...
                                        <!--<p class="chevron"><i class="fa fa-chevron-right pull-right" aria-hidden="true"></i></p>-->
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <a href="/site/57ffbc26-3c72-11e8-8498-b88198600e3c/vs/1/?unit_type=1000 CFM HRV">
      ...
      <div class="col-xs-12 card unit flex-justify-space">
        <div class="row">
          <div class="col-xs-3">
            <img class=" unit-image" src="/images/units/1000 CFM HRV.png">
          </div>
          <h5 class="col-xs-7 card-headline">
            Alpha 3 Corv VS1K
          </h5>
          <div class="col-xs-2">
            <img class="status-light pull-right" style="width:15px; height:15px;" src="/images/icons/cluster-status/icon-1.png" data-bind-attr="src site_information.devices.0.unit_status:change_image_png,/images/icons/cluster-status/icon-">
          </div>
          <p class="col-xs-8" >
    ...
    <a href="/site/57ffbc26-3c72-11e8-8498-b88198600e3c/fjvrf_outdoor/1/?unit_type=J-II">
      ...
      <div class="col-xs-12 card unit flex-justify-space">
        <div class="row">
          <div class="col-xs-3">
            <img class=" unit-image" src="/images/units/J-II.png">
          </div>
          <h5 class="col-xs-7 card-headline">
            VRF Outdoor Master
          </h5>
