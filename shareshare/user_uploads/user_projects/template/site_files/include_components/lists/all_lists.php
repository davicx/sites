...
<!-- LIST -->
<div id = "js-individual-list_<?php echo $display_list_id; ?>" class = "js-individual-list individual-list ">
	
	<!-- NORMAL DISPLAY -->
	<div id = "js-list-area_<?php echo $display_list_id; ?>" class = "js-list-area ">
		
		<!-- LIST: Icon -->
		<div class = "individual-list-icon">
			<img title = "" src="<?php echo ICON; ?>lists/lists_2.png" class = "individual-list-icon-image" alt="">
		</div>	
		
		<!-- LIST: Name -->
		<a id = "js-list-name_<?php echo $display_list_id; ?>" class = "<?php echo $list_selected_style; ?> " href="<?php echo $group_list_link; ?>">
			<div class = "individual-list-name">					
				<p id = "js-list-name-text_<?php echo $display_list_id; ?>" class = "individual-list-name-text"><?php echo $list_name; ?></p>
			</div>		
		</a>		
		
		<!-- LIST: Settings -->
		<div class = "individual-list-settings">
	...
	<!-- EDIT LIST -->
	<div id = "js-edit-list-area_<?php echo $display_list_id; ?>" class = "js-edit-list-area individual-list-edit hide">	
		
		<!-- EDIT LIST: Name and Info -->
		<div class = "individual-list-edit-text-input">
			...
			<!-- LIST: Name -->
			<div class = "individual-list-name">
				<input type="text" id = "js-edit-list-name-textarea_<?php echo $display_list_id; ?>" class = "js-edit-list-name-textarea edit-list-name-text-box " name="" value="<?php echo $list_name; ?>">
			</div>		
		...
		<div class = "individual-list-edit-action">
			...
			<div class = "individual-list-name">
				<p id = "js-rename-list_<?php echo $display_list_id; ?>" class = "js-rename-list button-blue edit-list-button " > save </p> 
				<p id = "" class = "js-cancel-edit-list button-white edit-list-button"> cancel </p> 
				<p id = "js-delete-list_<?php echo $display_list_id; ?>" class = "js-delete-list button-white edit-list-button " > delete </p>	 	
			</div>	
...
<?php /*
<div id = "js-individual-list_<?php echo $display_list_id; ?>" class = "js-individual-list js-master-list-right-click list-master ">
