...
<html>
    <head>
		...
		<link rel="stylesheet" href="../css/mobile_temp.css">		
	...
	<body> 
		...
		<header>
			...
			<div id = "logo">	
				<img title = "Home Page" src="<?php echo ICON; ?>logo/cloud.png" id = "logo-image" class = "" alt="">
			</div>
			<div id = "search">	
				<p> &nbsp </p>
			</div>
			<div id = "menu-mobile">	
				<img title = "Home Page" src="<?php echo ICON; ?>menu_icon/menu_2.png" id = "menu-image" class = "hide" alt="">
		
					<i class="fa fa-bars fa-3x mobile-menu-icon-fa" aria-hidden="true"></i>
