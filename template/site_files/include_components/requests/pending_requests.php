...
<?php } else {
	...
	?>
		...
		<!-- Individual Request -->
		<div id = "js-request_<?php echo $request_id; ?>" class = "">
			...
			if(strcasecmp($request_type,"new_group") == 0) { ?>
				...
				<p class = "text-zero"><b> <?php echo $group_name ?> </b></p>	
				<p id = "js-accept-group-request_<?php echo $request_id; ?>" class = "js-accept-group-request text-zero pointer" >  Join Group </p>
				<p id = "js-decline-group-request_<?php echo $request_id; ?>" class = "js-decline-group-request text-zero pointer" > Decline </p>

			<?php } else if(strcasecmp($request_type,"group_invite") == 0) { ?>
			...
			<?php } else if (strcasecmp($request_type,"friend") == 0){ ?>
			
				<!-- Request Type 2: Friend Request -->
				<p id = "js-accept-friend-request_<?php echo $sent_by_id; ?>" class = "js-accept-friend-request text-zero pointer" > accept </p>
				<p id = "js-decline-friend-request_<?php echo $sent_by_id; ?>" class = "js-decline-friend-request text-zero pointer" > decline </p>	
