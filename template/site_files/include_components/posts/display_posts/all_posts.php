...
<?php
	...
	//PART 1: Select All Posts (Boards)	
	/*
	...
	*/ 
	...
	//PART 1: Select All Posts (Normal)	
	$sql = "SELECT * FROM posts WHERE post_status = '1' AND
		(post_type = 'photo' OR post_type = 'video' OR post_type = 'text' OR post_type = 'article' OR post_type = 'file' ) AND post_to = '$post_to'
			ORDER BY post_id DESC";
	$result = $conn->query($sql) or die(mysqli_error());
