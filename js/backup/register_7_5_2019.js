...
$(document).ready(function(){
	$("#js-register-user").click(function(){	
		...
		var registration_email_valid = validateEmail(registration_email); //true or false 
		...
		function(data) {	
			...
			if(user_name_test_array["username_failure"]==1) {
				$("#registration-errors").append("<p>" + user_name_test_array["user_name_message"] + "</p>");
			} 
			
			if (user_name_test_array["full_name_failure"]==1){
				$("#registration-errors").append("<p>" + user_name_test_array["full_name_message"] + "</p>");				
			} 
			
			if (user_name_test_array["password_failure"]==1){
				$("#registration-errors").append("<p>" + user_name_test_array["password_message"] + "</p>");				
			} 
			
			if (user_name_test_array["email_failure"]==1){
				$("#registration-errors").append("<p>" + user_name_test_array["email_message"] + "</p>");				
			} 
...
/*	
	...
	$email_is_required 			= $_POST["email_is_required"]; 
