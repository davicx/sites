...
$(document).ready(function(){
	$(".js-accept-group-request").click(function(){
		...
		//console.log(accept_group_request_id + " " + logged_in_user + " SENT BY " + sent_by + " " + group_id + " " + master_site);
		$.post(CODE_ROOT + 'user.php', { 
			accept_group_request_id: accept_group_request_id, 
		...
		/*
			...
			$("#js-request_" + accept_group_request_id).hide();
		*/
		})		
	});
});
	...
	$("#js-reset-password-submit").click(function(){
		...
		if (reset_password_email) {
			...
			if(email_false.localeCompare(email_validation)) { 	
				...
				function(data) {	
					//var password_update_status = data;
