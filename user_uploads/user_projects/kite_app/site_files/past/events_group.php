	...
	<body> 
		...
		<div class = "mobile">
			...
			<div class = "mobile-header">
				<?php include_once('include_components/headers/evently_events_header.php') ?>	
			</div>	
			
			<!-- MOBILE: Body -->			
			<div class = "mobile-body">
				<?php include_once('include_components/evently/event_feed_discover.php') ?>				
			</div>		
