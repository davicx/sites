    ...
    <div class="uk-modal-dialog">
		...
		<div class="uk-grid ">
			...
			<div id = "js-make-post-photo" class="hide make-post-area uk-width-1-1 uk-grid-full-adjust">
				<?php include('include_components/posts/posts_shareshare/make_post/make_post_photo.php'); ?>
			</div>
						
			<!-- Post Type: Video -->			
			<div id = "js-make-post-video" class="hide uk-width-1-1 uk-grid-full-adjust">
				<?php include('include_components/posts/posts_shareshare/make_post/make_post_video.php'); ?>
			</div>
						
			<!-- Post Type: Article -->			
			<div id = "js-make-post-article" class="hide uk-width-1-1 uk-grid-full-adjust">
				<?php include('include_components/posts/posts_shareshare/make_post/make_post_article.php'); ?>			
			</div>
						
			<!-- Post Type: Text -->			
			<div id = "js-make-post-text" class="hide uk-width-1-1 uk-grid-full-adjust">
				<?php include('include_components/posts/posts_shareshare/make_post/make_post_text.php'); ?>			
			</div>
						
			<!-- Post Type: File -->			
			<div id = "js-make-post-file" class="hide uk-width-1-1 uk-grid-full-adjust">
				<?php include('include_components/posts/posts_shareshare/make_post/make_post_file.php'); ?>		
			</div>
