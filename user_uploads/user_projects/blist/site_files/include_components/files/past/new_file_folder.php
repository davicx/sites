...
/*
	<div class = "file-actions-header">	
		<p class = "file-action-new-file-text"> File (+) </p>	
		<p class = "file-action-new-folder-text"> Folder (+)  </p>		
	</div>	

	<div class = "file-actions-body">							
		<p class = "file-action-new-file-name-text" > File Name </p>		
	</div>	
*/
?>