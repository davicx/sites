...
FUNCTIONS A: Registration and Login Functions
	1) Function A1: Register User 
	2) Function A2: Check if Username is Valid
	3) Function A3: Check if Full Name is Valid
	4) Function A4: Check if Email is Valid
	5) Function A5: Check if Password is Valid	
	
*/	

//FUNCTIONS A: Registration and Login Functions

//Function A1: Register User 
...
if (isset($_POST["register_new_user"]) && (!empty($_POST["register_new_user"]))) {	
	...
	if ($email_is_required == 1) {	
		...
		//VALID EMAIL: Check if Email is a Valid Email 
		if(strcasecmp($registration_email_valid, "true") == 0) {
			...
			if($email_is_taken == 1) {
				...
				//$register_outcome_array['email_message'] = "VALID TAKEN " . $email_is_taken;				
			
			//EMAIL OK
			} else {			
				$register_outcome_array['email_failure'] = 0;	
				$register_outcome_array['email_message'] = "VALID Email was registered";			
			}
		...
		//INVALID EMAIL: Not a Valid Email 
			...
			$register_outcome_array['master_success'] = 0;
			$register_outcome_array['email_failure'] = 1;	
			$register_outcome_array['email_message'] = "INVALID Please enter a valid email";			
		}		
	} 
	...
	if ($total_errors == 0 && !empty($registration_user_name)) {
...
//Function A2: Check if Username is Valid
...
//Function A3: Check if Full Name is Valid 
...
//Function R4: Check if Email is Valid 
/*
if (isset($_POST["registration_email"]) && (!empty($_POST["registration_email"]))) {	
...
//Function R5: Check if Password is Valid	
//* No Server Code
